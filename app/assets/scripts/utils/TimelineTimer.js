    ...
    render(){
        return(
            <div>
                ...
                <div style={{display:"flex", marginRight:'20px', width:'86px', justifyContent:'space-between'}}>
                    {this.state.playIcon && <Input type="number" min="5" max="60" value={this.state.value} onChange={this.changeHandler}/>}
                    {!this.state.playIcon && <div className="base-timer" style={{position:'relative', height:'37px', width:'37px'}}>
                        <svg className="base-timer__svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            <g className="base-timer__circle" style={{fill:'none', stroke:'none'}}>
                            <circle className="base-timer__path-elapsed" cx="50" cy="50" r="45" style={{strokeWidth:'10px', stroke:'green'}}/>
                            </g>
                        </svg>
